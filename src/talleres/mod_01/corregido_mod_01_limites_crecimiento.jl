...
begin
	...
	"""
	La función crecimiento_limitado(dS,u,p,t)

	Define el modelo de simulación de crecimiento acotado por capacidad de carga de Verhulst.

	La función recibe los siguientes argumentos:
	* dS : Es un arreglo que guarda el valor de la tasa de cambio
	* u  : Es un arreglo que guarda el nivel de los stocks
	* p  : Es un arreglo que guarda el valor de los parámetros
	* t  : Es un arreglo que guarda el periodo inicial y final
	"""
	function crecimiento_limitado(dS, u, p, t)

	end

	@doc crecimiento_limitado
end
...
begin
	...
	S0 = 1000.0
	## Incorporamos el valor inicial del stock en el arreglo que guarda los stock
	u0 = [S0]
	...
	parametros = [capacity, ref_growth_rate, ref_availability]
	...
	prob1 = ODEProblem(crecimiento_limitado, u0, tiempo, parametros)
	sol = solve(prob1, DifferentialEquations.RK4(), dt = h_prob1,adaptive=false)

end

# ╔═╡ a4222ff4-2229-488b-867d-8d108e0d18f3
...
manifest_format = "2.0"
project_hash = "1698f0c9c59ad6d78a021c425ea2db341c8303d1"
